...
CGLS_NDVI300_GLOBE_OLCI_V201 = CGLSProduct(
    **{
        ...
        "patn_manifest": r"$(yyyy)/$(yyyy)$(mm)$(dd)/c_gls_NDVI300_$(yyyy)$(mm)$(dd)0000_GLOBE_OLCI_V2.0.(?P<run_number>\d+).nc",
...
CGLS_NDVI1K_GLOBE_PROBAV_V301 = CGLSProduct(
    **{
        ...
        "patn_manifest": r"$(yyyy)/$(yyyy)$(mm)$(dd)/c_gls_NDVI_$(yyyy)$(mm)$(dd)0000_GLOBE_PROBAV_V3.0.(?P<run_number>\d+).nc",
...
CGLS_NDVI1K_GLOBE_VGT_V301 = CGLSProduct(
    **{
        "variable": "NDVI",
        "manifest": f"{manifest_baseurl}/ndvi_1km_v3_10daily_netcdf/manifest_clms_global_ndvi_1km_v3_10daily_netcdf_latest.txt",
        "patn_manifest": r"$(yyyy)/$(yyyy)$(mm)$(dd)/c_gls_NDVI_$(yyyy)$(mm)$(dd)0000_GLOBE_VGT_V3.0.(?P<run_number>\d+).nc",
